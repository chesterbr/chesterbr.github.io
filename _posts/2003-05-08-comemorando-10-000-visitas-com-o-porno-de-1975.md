...
O resultado final é tão bizarro e hilário que, em comemoração aos 10.000 visitantes da página, resolvi digitalizar e disponbilizar toda a revista online (as páginas estão logo abaixo). Pode abrir com a avó na sala numa boa &#8211; qualquer filme romântico atual tem mais nu que isso.
...
Clique numa página para ver em tamanho grande.

<div class="gallery">
{% for i in (1..64) %}{% if i < 10 %}{% assign n = "0" | append: i %}{% else %}{% assign n = i %}{% endif %}<a href="/img/gep/gep{{ n }}.jpg"><img src="/img/gep/gep{{ n }}_t.jpg" alt="página {{ n }}" loading="lazy" /></a>
{% endfor %}
</div>
