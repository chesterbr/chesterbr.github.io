...
categories:
---
Só pra avisar: coloquei no ar a versão 3.17 do [miniTruco][1] (siga o link para instruções de download.) A mudança mais significativa é que agora você pode usar seu login do <a class="dead-link" title="este link morreu" href="http://gtruco.com.br">gTruco</a><span class="dead-link-mark">†</span> (ou, se preferir, entrar como convidado e digitar seu apelido na hora, como nas versões anteriores.)
