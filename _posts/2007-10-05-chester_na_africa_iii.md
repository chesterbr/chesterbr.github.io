...
<img title="Moeda de R5" src="/archives/img/rand.jpg" width="110" height="106" class="mt-image-right" style="float: right; margin: 0 0 20px 20px;" />Voltando ao Canal Walk: o lugar é gigantesco e tem todo os os tipos de lojas internacionais que se possa imaginar, mais umas tantas marcas locais, lançando por terra qualquer estereótipo de &#8220;selva e deserto&#8221; que a pessoa tenha do país. A <a href="/archives/img/praca_alimentacao_canal_walk.html" onclick="window.open('/archives/img/praca_alimentacao_canal_walk.html','popup','width="800",height="600",scrollbars=no,resizable=no,toolbar=no,directories=no,location=no,menubar=no,status=no,left=0,top=0'); return false">praça de alimentação</a> (clique para ver) é insanamente kitsch, no melhor estilo Neo-Tokyo &#8211; tanto que só no final do jantar me dei conta de que ela tinha um fliperama.
