...
Enter [I Want Sandy][8], a web application that combines email and calendar in a very smart way. It allows me to literally time-shift email: I just forward it to her, with a subject such as &#8220;Remind me to read this tomorrow in the afternoon&#8221;, and the email comes back at the specified time (I can be as specific as I want &#8211; <a href="http://web.archive.org/web/20081219184330/http://iwantsandy.com:80/examples/for/professionals">she is quite good</a> at guessing the details when I get vague).
