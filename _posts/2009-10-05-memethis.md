...
O [código-fonte][13] é escrito em Java, e é [livre][14]. A parte dos bastidores (que faz toda a mágica acontecer) roda no <a href="http://web.archive.org/web/20120311080319/http://code.google.com:80/intl/pt-BR/appengine/">Google App Engine</a> &#8211; como bem observou um [amigo][16] nosso, usamos uma linguagem da Sun para ampliar um serviço do Yahoo! usando um outro serviço do Google. *Web 2.0* é isso! :-P
