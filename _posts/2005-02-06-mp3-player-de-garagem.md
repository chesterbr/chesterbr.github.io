...
Claro, é preciso ter vários componentes &#8220;tradicionais&#8221; (resistores, capacitores) para conectar esses módulos todos, fora que a montagem não é muito simples de executar (o cara é do MIT, e recomenda um <a class="dead-link" title="este link morreu" href="http://www.walrus.com/~raphael/html/mp3.html" >outro projeto menos radical</a><span class="dead-link-mark">†</span> para os mortais). Ainda assim, ele ilustra o quanto o &#8220;hobbyismo&#8221; em eletrônica evoluiu desde o final dos anos 70.
