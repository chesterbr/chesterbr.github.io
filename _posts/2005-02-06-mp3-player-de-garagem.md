...
Claro, é preciso ter vários componentes &#8220;tradicionais&#8221; (resistores, capacitores) para conectar esses módulos todos, fora que a montagem não é muito simples de executar (o cara é do MIT, e recomenda um <a href="http://web.archive.org/web/20181201024436/http://www.walrus.com:80/~raphael/html/mp3.html?" >outro projeto menos radical</a> para os mortais). Ainda assim, ele ilustra o quanto o &#8220;hobbyismo&#8221; em eletrônica evoluiu desde o final dos anos 70.
